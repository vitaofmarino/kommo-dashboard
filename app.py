...
# Conexão otimizada para GitHub Actions usando o Pooler do Supabase (Porta 6543)
USER = "postgres.mwdhclwookhpwzrhfjjp"
HOST = "aws-1-us-east-2.pooler.supabase.com"
PORT = "6543"
DBNAME = "postgres"
PASSWORD = quote_plus("Cafe2021@@*") # Se você trocou a senha há pouco no Supabase, coloque a nova aqui!
...
# Criando a tabela já com o campo contact_id e cliente_nome
query_criar_tabela = """
...
-- Garantir que a coluna contact_id exista caso a tabela já estivesse criada
...
while True:
    ...
    for l in leads:
        ...
        # Puxa o ID do primeiro contato vinculado ao lead (se houver)
