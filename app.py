...
# URL Limpa: Removido o pgbouncer=true e adicionado o sslmode=require compatível com Python
SUPABASE_URL = "postgresql+psycopg2://postgres.mwdhclwookhpwzrhfjjp:%5BRomeuzinho24%5D@aws-1-us-east-2.pooler.supabase.com:6543/postgres?sslmode=require"
